    ...
    <footer className='footer__container'>
      <div className='top-footer'>
        <div className='col col-2'>
          <div className='widget-title'>Dr Vasantdada Patil School</div>
      ...
      <div className='bottom-footer'>
        <div className='copyright'>Copyright 2023 &copy; Dr Vasantdada Patil School </div>
